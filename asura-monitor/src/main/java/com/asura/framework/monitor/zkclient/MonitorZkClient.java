...
public final class MonitorZkClient {
    ...
    private void start() {
        ...
        if (address.startsWith("zookeeper") && address.length() > 20) {
            ...
            //输出成功信息
            System.out.println(new SimpleDateFormat("[yyyy-MM-dd HH:mm:ss] ").format(new Date()) + "Monitor connected to zookeeper server(" + zookeeperServer + ")!");
        } else {

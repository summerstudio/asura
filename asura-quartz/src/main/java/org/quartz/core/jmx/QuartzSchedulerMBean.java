...
public interface QuartzSchedulerMBean {
	 ...
	 * @throws SchedulerException
	 * @see org.quartz.core.jmx.JobDetailSupport
	 */
	 ...
	 * @throws SchedulerException
	 * @see org.quartz.core.jmx.TriggerSupport
	 */
	...
	void triggerJobWithVolatileTrigger(String instanceId, String jobName, String jobGroupName, Map<String, String> jobDataMap)
			throws SchedulerException;

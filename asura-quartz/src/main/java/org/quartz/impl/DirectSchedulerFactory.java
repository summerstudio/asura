...
public class DirectSchedulerFactory implements SchedulerFactory {
     ...
     * via {@link org.quartz.impl.DirectSchedulerFactory#getScheduler()}
     *
     * @param rmiHost
    ...
    /**
     * Same as
     * {@link org.quartz.impl.DirectSchedulerFactory#createRemoteScheduler(String rmiHost, int rmiPort)},
     * with the addition of specifying the scheduler name and instance ID. This
     * scheduler can only be retrieved via
     * {@link org.quartz.impl.DirectSchedulerFactory#getScheduler(String)}
     *
     * @param schedulerName
     ...
     * {@link org.quartz.impl.DirectSchedulerFactory#getScheduler()}
     *
     * @param threadPool
    ...
    /**
     * Same as
     * {@link org.quartz.impl.DirectSchedulerFactory#createScheduler(org.quartz.spi.ThreadPool threadPool, org.quartz.spi.JobStore jobStore)},
     * with the addition of specifying the scheduler name and instance ID. This
     * scheduler can only be retrieved via
     * {@link org.quartz.impl.DirectSchedulerFactory#getScheduler(String)}
     *

...
public class DailyCalendar extends BaseCalendar {
     ...
     * <code>{@link java.util.TimeZone#getDefault()}</code> time zone unless an explicit
     * time zone is set via <code>{@link org.quartz.impl.calendar.BaseCalendar#setTimeZone(java.util.TimeZone)}</code>
     * </p>
     *  
     ...
     *                          &ndash; see {@link org.quartz.impl.calendar.BaseCalendar} for more
     ...
     *                                  instance &ndash; see 
     *                                  {@link org.quartz.impl.calendar.BaseCalendar} for more
     ...
     * <code>{@link java.util.TimeZone#getDefault()}</code> time zone unless an explicit
     * time zone is set via <code>{@link org.quartz.impl.calendar.BaseCalendar#setTimeZone(java.util.TimeZone)}</code>.
     * You should use <code>{@link #DailyCalendar(String, java.util.TimeZone, long, long)}</code>
     ...
     * <code>{@link java.util.TimeZone#getDefault()}</code> time zone unless an explicit
     * time zone is set via <code>{@link org.quartz.impl.calendar.BaseCalendar#setTimeZone(java.util.TimeZone)}</code>.
     * You should use <code>{@link #DailyCalendar(String, java.util.Calendar, java.util.TimeZone, long, long)}</code>
     * if you don't want the given <code>rangeStartingTimeInMillis</code> and
     * <code>rangeEndingTimeInMillis</code> to be evaluated in the default 
     * time zone.
     * </p>
     ...
     *                                  org.quartz.impl.calendar.BaseCalendar} for more information on

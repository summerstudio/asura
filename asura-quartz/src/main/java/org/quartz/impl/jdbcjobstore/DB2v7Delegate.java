 ...
 * <code>{@link java.sql.PreparedStatement#setObject(int, Object, int)}</code>
 * rather than <code>{@link java.sql.PreparedStatement#setBytes(int, byte[])}</code>.
 * </p>
 * 
 * @author Blair Jensen
 */
public class DB2v7Delegate extends StdJDBCDelegate {
     ...
     * Wraps <code>{@link java.sql.PreparedStatement#setObject(int, Object, int)}</code> rather than
     * <code>{@link java.sql.PreparedStatement#setBytes(int, byte[])}</code> as required by the
     * DB2 v7 database.
     */

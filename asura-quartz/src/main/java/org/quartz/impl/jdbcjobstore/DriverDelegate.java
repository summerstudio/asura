...
public interface DriverDelegate {
     ...
     * org.quartz.utils.Key}</code> objects
     */
    Key[] selectMisfiredTriggersInState(Connection conn, String state, long ts) throws SQLException;
     ...
     *         the given count.
     */
    boolean selectMisfiredTriggersInStates(Connection conn, String state1, String state2, long ts, int count, List resultList) throws SQLException;
     ...
     * @param conn the DB Connection
     */
    int countMisfiredTriggersInStates(Connection conn, String state1, String state2, long ts) throws SQLException;
     ...
     * org.quartz.utils.Key}</code> objects
     */
    Key[] selectMisfiredTriggersInGroupInState(Connection conn, String groupName, String state, long ts) throws SQLException;
     ...
     * org.quartz.utils.Key}</code> objects
     */
    Key[] selectTriggerNamesForJob(Connection conn, String jobName, String groupName) throws SQLException;
     ...
     * @return the number of rows deleted
     */
    int deleteJobListeners(Connection conn, String jobName, String groupName) throws SQLException;
     ...
     */
    boolean isJobStateful(Connection conn, String jobName, String groupName) throws SQLException;
     ...
     */
    String[] selectJobListeners(Connection conn, String jobName, String groupName) throws SQLException;
     ...
     * @return the number of rows inserted
     */
    int insertTrigger(Connection conn, Trigger trigger, String state, JobDetail jobDetail) throws SQLException, IOException;
     ...
     * @return the number of rows updated
     */
    int updateTrigger(Connection conn, Trigger trigger, String state, JobDetail jobDetail) throws SQLException, IOException;
     ...
     * @return the number of rows updated
     */
    boolean triggerExists(Connection conn, String triggerName, String groupName) throws SQLException;
     ...
     */
    int updateTriggerStateFromOtherState(Connection conn, String triggerName, String groupName, String newState, String oldState) throws SQLException;
     ...
     * @throws java.sql.SQLException
     */
    int updateTriggerGroupStateFromOtherStates(Connection conn, String groupName, String newState, String oldState1, String oldState2, String oldState3) throws SQLException;
     ...
     * @return the number of rows updated
     */
    int updateTriggerStatesForJob(Connection conn, String jobName, String groupName, String state) throws SQLException;
     ...
     * @return the number of rows deleted
     */
    int deleteTriggerListeners(Connection conn, String triggerName, String groupName) throws SQLException;
     ...
     * @return the number of rows inserted
     */
    int insertTriggerListener(Connection conn, Trigger trigger, String listener) throws SQLException;
     ...
     */
    String[] selectTriggerListeners(Connection conn, String triggerName, String groupName) throws SQLException;
     ...
     * @return the number of rows deleted
     */
    int deleteSimpleTrigger(Connection conn, String triggerName, String groupName) throws SQLException;
     ...
     * @return the number of rows deleted
     */
    int deleteBlobTrigger(Connection conn, String triggerName, String groupName) throws SQLException;
     ...
     * @return the number of rows deleted
     */
    int deleteCronTrigger(Connection conn, String triggerName, String groupName) throws SQLException;
     ...
     * @return the number of rows deleted
     */
    int deleteTrigger(Connection conn, String triggerName, String groupName) throws SQLException;
     ...
     */
    int selectNumTriggersForJob(Connection conn, String jobName, String groupName) throws SQLException;
     ...
     * @throws java.sql.SQLException
     */
    String selectJobClassForTrigger(Connection conn, String triggerName, String groupName)
            throws SQLException;
     ...
     */
    List selectStatefulJobsOfTriggerGroup(Connection conn, String groupName) throws SQLException;
     ...
     */
    Trigger selectTrigger(Connection conn, String triggerName, String groupName) throws SQLException, ClassNotFoundException,
        IOException;
     ...
     * @return the <code>{@link org.quartz.Trigger}</code> object
     */
    String selectTriggerState(Connection conn, String triggerName, String groupName) throws SQLException;
     ...
     */
    TriggerStatus selectTriggerStatus(Connection conn, String triggerName, String groupName) throws SQLException;
     ...
     * @return the number of rows inserted
     */
    int insertFiredTrigger(Connection conn, Trigger trigger, String state, JobDetail jobDetail) throws SQLException;
     ...
     * @return a List of FiredTriggerRecord objects.
     */
    List selectInstancesFiredTriggerRecords(Connection conn, String instanceName) throws SQLException;
     ...
     */
    int selectJobExecutionCount(Connection conn, String jobName, String jobGroup) throws SQLException;

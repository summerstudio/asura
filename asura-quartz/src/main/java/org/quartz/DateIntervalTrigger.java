...
/**
 * <p>A concrete <code>{@link org.quartz.Trigger}</code> that is used to fire a <code>{@link JobDetail}</code>
 ...
 * (see {@link #setRepeatIntervalUnit(org.quartz.DateIntervalTrigger.IntervalUnit)}) as specified in the trigger's definition.
 * This trigger can achieve schedules that are not possible with {@link org.quartz.SimpleTrigger} (e.g
 * because months are not a fixed number of seconds) or {@link org.quartz.CronTrigger} (e.g. because
...
public class DateIntervalTrigger extends Trigger {
     ...
     * situation, the <code>{@link org.quartz.DateIntervalTrigger}</code> wants to be
     ...
     * <p>
     * Instructs the <code>{@link org.quartz.Scheduler}</code> that upon a mis-fire
     * situation, the <code>{@link org.quartz.DateIntervalTrigger}</code> wants to have it's
    ...
    /**
     *  
     * @see Trigger#updateWithNewCalendar(org.quartz.Calendar, long)
     */
    @Override
     ...
     * @see #triggered(java.util.Calendar)
     */
    @Override

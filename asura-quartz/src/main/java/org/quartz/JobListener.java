 ...
 * <code>{@link JobDetail}</code> executes.
 * </p>
 * 
...
public interface JobListener {
     ...
     * is about to be executed (an associated <code>{@link org.quartz.Trigger}</code>
     * has occurred).
     * </p>
     * 
     * <p>
     ...
     * <p>
     * Called by the <code>{@link org.quartz.Scheduler}</code> when a <code>{@link JobDetail}</code>
     * was about to be executed (an associated <code>{@link org.quartz.Trigger}</code>
    ...
    /**
     * <p>
     * Called by the <code>{@link org.quartz.Scheduler}</code> after a <code>{@link JobDetail}</code>

 ...
 * configuration of <code>{@link org.quartz.Trigger}s</code> and <code>Date</code>s
 * </p>
 * 
 * 
...
public class TriggerUtils {
     ...
     * @return the new rounded date
     * 
     * @see #getNextGivenSecondDate(java.util.Date, int)
     */
     ...
     * @return the new rounded date
     * 
     * @see #getNextGivenMinuteDate(java.util.Date, int)
     */

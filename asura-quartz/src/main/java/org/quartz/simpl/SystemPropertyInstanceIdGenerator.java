...
/**
 * InstanceIdGenerator that will use a {@link org.quartz.simpl.SystemPropertyInstanceIdGenerator#SYSTEM_PROPERTY system property}
...
public class SystemPropertyInstanceIdGenerator implements InstanceIdGenerator {
   ...
   * @return the value of the {@link org.quartz.simpl.SystemPropertyInstanceIdGenerator#SYSTEM_PROPERTY system property}

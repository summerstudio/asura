...
public abstract class Trigger implements java.io.Serializable, Cloneable,
    ...
    */
    ...
    /**
     * <p>
     * Instructs the <code>{@link Scheduler}</code> that the <code>{@link org.quartz.Trigger}</code>
    ...
    */
     ...
     * </p>
     * 
     * @see TriggerUtils#computeEndTimeToAllowParticularNumberOfFirings(org.quartz.Trigger, Calendar, int)
     */ 
     ...
     * </p>
     *
     * @see TriggerUtils#computeFireTimesBetween(org.quartz.Trigger, Calendar, java.util.Date, java.util.Date)
     */

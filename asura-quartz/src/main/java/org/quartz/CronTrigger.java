...
public class CronTrigger extends Trigger {
     ...
     * situation, the <code>{@link org.quartz.CronTrigger}</code> wants to be fired now
     ...
     * <p>
     * Instructs the <code>{@link org.quartz.Scheduler}</code> that upon a mis-fire
     * situation, the <code>{@link org.quartz.CronTrigger}</code> wants to have it's
     ...
     * </p>
     *
     * @see TriggerUtils#computeFireTimesBetween(org.quartz.Trigger, org.quartz.Calendar , java.util.Date, java.util.Date)
     */

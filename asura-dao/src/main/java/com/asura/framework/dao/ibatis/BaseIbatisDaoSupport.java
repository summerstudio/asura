...
import com.asura.framework.dao.ibatis.rule.Rule;
import com.asura.framework.dao.ibatis.rule.ShardTableRule;
...
public class BaseIbatisDaoSupport implements InitializingBean {
    ...
    /**
     * @param shardTableRule
     *         the shardTableRule to set
     */
    ...
    /**
     * @param readSqlMapClient
     *         the readSqlMapClient to set
     */
    ...
    /**
     * @param writeSqlMapClient
     *         the writeSqlMapClient to set
     */
    ...
    private Map<String, Object> executeRouter(final String sqlId, final Map<String, Object> params) throws DataAccessException {
